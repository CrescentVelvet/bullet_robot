...
//    qDebug() << fit_msg;
//    GDebugEngine::instance()->gui_debug_msg(CGeoPoint(-4200,-2200),fit_msg.toLatin1(),COLOR_GREEN);
//     dribble -1 ~ +1 -> -3 ~ +3
...
//    KParamManager::instance()->loadParam(min_power, key, 30);
...
//    KParamManager::instance()->loadParam(max_power, key, 70);
    ...
    GDebugEngine::instance()->gui_debug_msg(CGeoPoint(-4200,-2150),QString("time : %1").arg(current_time).toLatin1(),COLOR_GREEN);
    GDebugEngine::instance()->gui_debug_msg(CGeoPoint(-4200,-2300),QString("id : %1").arg(id).toLatin1(),COLOR_GREEN);
    GDebugEngine::instance()->gui_debug_msg(CGeoPoint(-4200,-2450),QString(" b : %1").arg(b).toLatin1(),COLOR_GREEN);
    GDebugEngine::instance()->gui_debug_msg(CGeoPoint(-4200,-2600),QString(" c : %1").arg(c).toLatin1(),COLOR_GREEN);
