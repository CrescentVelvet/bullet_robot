...
def __pars_args__():
    ...
    parser.add_argument('-m_path', '--model_path', default='./trained_model',
...
if __name__ == '__main__':
    ...
    obs_size = env.observation_space.shape[0] # 模型定义
    act_space = env.action_space.shape[0]
    model = PPO2(input_dim=obs_size, hidden_dim=args.hidden_dim, action_space=act_space, dropout=0)
    model.to(device)
