...
class PPO:
    def __init__(self, env, **hyperparameters):
        ...
        self.actor_optim = Adam(self.actor.parameters(), lr=2.5e-6) # 定义Adam优化器
        self.critic_optim = Adam(self.critic.parameters(), lr=1e-4) # 定义Adam优化器
    ...
    def learn(self, total_timesteps):
        ...
        while t_so_far < total_timesteps: # 循环设定总步数
            ...
            critic_loss = torch.nn.MSELoss()(V, batch_rtgs) # 计算loss
